...
insert into public.dedicated_plans (id,name,cpu,cores,ram,disk,net,ip,price,tagline,href,popular,sort_order) values ('e3','Intel Xeon E3-1230 V5','Intel Xeon E3-1230 V5 @ 3.4 GHz','4 Cores / 8 Threads','32 GB DDR4','1 TB SSD','1 Gbps Ilimitado','IPv4 + IPv6','$50.00','Ideal para proyectos personales','https://my.terranode.net/store/dedicated-servers',false,0)
  on conflict (id) do update set name=excluded.name,cpu=excluded.cpu,cores=excluded.cores,ram=excluded.ram,disk=excluded.disk,net=excluded.net,ip=excluded.ip,price=excluded.price,tagline=excluded.tagline,href=excluded.href,popular=excluded.popular,sort_order=excluded.sort_order;
insert into public.dedicated_plans (id,name,cpu,cores,ram,disk,net,ip,price,tagline,href,popular,sort_order) values ('e5','Intel Xeon Dual E5-2680 V4','Intel Xeon Dual E5-2680 V4 @ 2.4 GHz','28 Cores / 56 Threads','128 GB DDR4','1 TB SSD','1 Gbps Ilimitado','IPv4 + IPv6','$94.99','Para proyectos en crecimiento','https://my.terranode.net/store/dedicated-servers',true,1)
  on conflict (id) do update set name=excluded.name,cpu=excluded.cpu,cores=excluded.cores,ram=excluded.ram,disk=excluded.disk,net=excluded.net,ip=excluded.ip,price=excluded.price,tagline=excluded.tagline,href=excluded.href,popular=excluded.popular,sort_order=excluded.sort_order;
insert into public.dedicated_plans (id,name,cpu,cores,ram,disk,net,ip,price,tagline,href,popular,sort_order) values ('gold','Intel Xeon Dual Gold 6138','Intel Xeon Dual Gold 6138 @ 2.0 GHz','40 Cores / 80 Threads','256 GB DDR4','2 TB U.2 NVMe','10 Gbps (330 TB)','IPv4 + IPv6','$149.99','Para proyectos escalables y empresariales','https://my.terranode.net/store/dedicated-servers',false,2)
  on conflict (id) do update set name=excluded.name,cpu=excluded.cpu,cores=excluded.cores,ram=excluded.ram,disk=excluded.disk,net=excluded.net,ip=excluded.ip,price=excluded.price,tagline=excluded.tagline,href=excluded.href,popular=excluded.popular,sort_order=excluded.sort_order;
